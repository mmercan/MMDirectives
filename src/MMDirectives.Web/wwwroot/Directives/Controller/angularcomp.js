...
angular.module("app").controller("angularcomp", ["$scope", "$http", "$location", "rottentService", "notificationService", function ($scope, $http, $location, rottentService,notificationService) {
